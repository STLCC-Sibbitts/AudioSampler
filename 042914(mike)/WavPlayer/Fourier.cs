        ...
        public static void DFT( Complex[] data, Direction direction )
                {
                        ...
                        for ( int i = 0; i < n; i++ )
                        {
                                ...
                                for ( int j = 0; j < n; j++ )
                                {
                                        ...
                                        double a = data[j].Real * cos - data[j].Imaginary * sin;
                                        double b = data[j].Real * sin + data[j].Imaginary * cos;
                                        dst[i] = new Complex((dst[i].Real + a) ,(dst[i].Imaginary + b) );
            ...
            if ( direction == Direction.Forward )
                        {
                                ...
                                for ( int i = 0; i < n; i++ )
                                {
                                    ...
                                    /*data[i].Real = dst[i].Real / n;
                                        data[i].Imaginary = dst[i].Imaginary / n;  */
                                }
                        }
                        else
                        {
                        ...
                        for ( int i = 0; i < n; i++ )
                        {
                                for ( int j = 0; j < m; j++ )
                                {
                                        ...
                                        for ( int k = 0; k < m; k++ )
                                        {
                                            ...
                                            dst[j] = new Complex( ( data[i, k].Real * cos - data[i, k].Imaginary * sin )+dst[j].Real, ( data[i, k].Real * sin + data[i, k].Imaginary * cos )+dst[j].Imaginary);
                                            /*
                        ...
                        for ( int j = 0; j < m; j++ )
                        {
                                for ( int i = 0; i < n; i++ )
                                {
                                        ...
                                        for ( int k = 0; k < n; k++ )
                                        {
                                            ...
                                            dst[i] = new Complex(( data[k, j].Real * cos - data[k, j].Imaginary * sin ) + dst[i].Real, ( data[k, j].Real * sin + data[k, j].Imaginary * cos ) + dst[i].Imaginary);
                                            /*
